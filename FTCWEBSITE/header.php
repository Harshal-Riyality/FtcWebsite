...
<head>
	...
	<!-- Page Title -->
    <title>Fabtech Technical College</title>
	<!-- Favicon Icon -->
	<link rel="shortcut icon" type="image/x-icon" href="images\FTC-images\FTC-logo.png">
	<!-- Google Fonts Css-->
...
<body>
	...
	<div class="preloader">
		<div class="loading-container">
			...
			<div id="loading-icon"><img src="images\FTC-images\FTC-logo.png" alt=""></div>
		</div>
	</div>
	<!-- Preloader End -->
